...
data class BidderProductListLatestResponseModel(
    ...
    data class Data(
        ...
        @SerializedName("adminComminsion") val adminCommission: Double? = null,
        @SerialName("highestRange") val highestRange: HighestRange? = null,
        @SerializedName("products") val products: List<Product>? = null
    ) {

        data class HighestRange(
            @SerialName("_id") val id: String? = null,
            @SerialName("maxAmount") val maxAmount: Float? = null
        )
        ...
        data class Product(
            ...
            @SerializedName("bidCount") val bidCount: String? = null,
